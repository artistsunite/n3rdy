"""Apply growth intelligence migration SQL to Neon PostgreSQL database."""
import os
import psycopg2
...
migration_path = os.path.join(
    ...
    '20260614000002_growth_intelligence', 'migration.sql'
)
...
try:
    cur.execute(sql)
    conn.commit()
    print('Growth intelligence migration applied successfully.')
